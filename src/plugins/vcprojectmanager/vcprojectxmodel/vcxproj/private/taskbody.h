...
**
****************************************************************************/
#ifndef VCPROJECTMANAGER_INTERNAL_VISUALSTUDIOPROJECTX_TASKBODY_H
#define VCPROJECTMANAGER_INTERNAL_VISUALSTUDIOPROJECTX_TASKBODY_H
...
class TaskBody : public IVisualStudioNodeX
{
public:
    TaskBody();
    ...
    void setEvaluate(const QString &evaluate);
...
#endif // VCPROJECTMANAGER_INTERNAL_VISUALSTUDIOPROJECTX_TASKBODY_H
