...
void ProjectExtensions::processNode(const QDomNode &node)
{
    m_node = node;
}

QDomNode ProjectExtensions::toXMLDomNode(QDomDocument &domXMLDocument) const
{
    Q_UNUSED(domXMLDocument);
    return m_node;
}
QDomNode ProjectExtensions::node() const
{
    return m_node;
}
