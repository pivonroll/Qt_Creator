...
**
****************************************************************************/
#ifndef VCPROJECTMANAGER_INTERNAL_VISUALSTUDIOPROJECTX_IMPORTGROUP_H
#define VCPROJECTMANAGER_INTERNAL_VISUALSTUDIOPROJECTX_IMPORTGROUP_H
...
class ImportGroup : public IVisualStudioNodeX
{
public:
    ImportGroup();
    ...
    void addImportElement(Import *import);
    void removeImportElement(Import *import);
...
#endif // VCPROJECTMANAGER_INTERNAL_VISUALSTUDIOPROJECTX_IMPORTGROUP_H
