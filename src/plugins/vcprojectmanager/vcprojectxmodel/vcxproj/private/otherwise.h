...
**
****************************************************************************/
#ifndef VCPROJECTMANAGER_INTERNAL_VISUALSTUDIOPROJECTX_OTHERWISE_H
#define VCPROJECTMANAGER_INTERNAL_VISUALSTUDIOPROJECTX_OTHERWISE_H
...
class Otherwise : public IVisualStudioNodeX
{
public:
    Otherwise();
    ...
    void removeChooseElement(Choose *choose);

    ItemGroup* itemGroupElement(int index) const;
    int itemGroupElementCount() const;
    void addItemGroup(ItemGroup *itemGroup);
    void removeItemGroup(ItemGroup *itemGroup);

    PropertyGroup* propertyGroupElement(int index) const;
    int propertyGroupElementCount() const;
...
private:
    ...
    QList<ItemGroup *> m_itemGroupElements;
    QList<PropertyGroup *> m_propertyGroupElements;
...
#endif // VCPROJECTMANAGER_INTERNAL_VISUALSTUDIOPROJECTX_OTHERWISE_H
