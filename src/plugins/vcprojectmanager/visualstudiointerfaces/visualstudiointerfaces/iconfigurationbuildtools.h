...
**
****************************************************************************/
#ifndef VCPROJECTMANAGER_INTERNAL_I_CONFIGURATION_BUILD_TOOLS_H
#define VCPROJECTMANAGER_INTERNAL_I_CONFIGURATION_BUILD_TOOLS_H
...
public:
    ...
    /*!
     * \brief Removes a tool from a container.
     */
    virtual void removeTool(IConfigurationBuildTool *tool) = 0;

    /*!
     * \return a tool with a \a toolKey.
     */
    ...
    /*!
     * \return a count of tools stored in a container.
     */
    virtual int toolCount() const = 0;

    /*!
     * \brief Appends tools stored in a container to an XML node \a domElement.
     * \a domDocument is used to create new XML nodes for tools.
     */
    virtual void appendToXMLNode(QDomElement &domElement, QDomDocument &domDocument) const = 0;
};
} // Internal
} // VcProjectManager
#endif // VCPROJECTMANAGER_INTERNAL_I_CONFIGURATION_BUILD_TOOLS_H
