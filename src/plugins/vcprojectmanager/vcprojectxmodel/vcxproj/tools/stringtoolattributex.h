...
**
****************************************************************************/
#ifndef VCPROJECTMANAGER_INTERNAL_VISUALSTUDIOPROJECTX_STRING_TOOL_ATTRIBUTE_X_H
#define VCPROJECTMANAGER_INTERNAL_VISUALSTUDIOPROJECTX_STRING_TOOL_ATTRIBUTE_X_H
...
class StringToolAttributeX : public BaseToolAttributeX
{
public:
...
#endif // VCPROJECTMANAGER_INTERNAL_VISUALSTUDIOPROJECTX_STRING_TOOL_ATTRIBUTE_X_H
