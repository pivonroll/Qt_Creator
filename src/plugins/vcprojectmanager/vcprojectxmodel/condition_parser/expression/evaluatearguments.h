...
public:
    ...
    void addArgument(const QString &argName, const QVariant &value);
    void removeArgument(const QString &argName);
    QVariant value(const QString &argName) const;

private:
    QMap<QString, QVariant> m_argValues;
};
