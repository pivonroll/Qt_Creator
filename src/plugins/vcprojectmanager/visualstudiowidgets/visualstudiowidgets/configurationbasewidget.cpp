 ...
 * A widget that provides visual representation of a Visual Studio's build configuration.
 *
 * \fn void saveData();
 * \reimp
 * Saves configuration data from widget to Visual Studio's build configuration.
 */
