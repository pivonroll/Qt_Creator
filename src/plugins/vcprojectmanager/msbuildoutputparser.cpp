...
/*! \class MsBuildOutputParser
    \brief This class is used to parse the output of a MSBuild.

    In order to parse the output of the MSBuild we use \ref MsBuildOutputParser.
    MSBuild has a little different message output than standard Miscrosoft compiler so it \
    is necessary to provide our own parser for those type of messages.
 */
...
/*!
        Constructs a MsBuildOutputParser object.
 */
